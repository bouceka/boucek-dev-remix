      ...
      <div className='row'>
        <div className='content'>
          ...
          <div className='content__description white p--xlarge'>
            ...
            <p>
              I moved to Canada and studied for an Advanced Digital Design and Development Diploma. It went so well that
              I graduated a year earlier than expected. All this could happen only because of all the strong women
